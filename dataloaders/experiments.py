...
class AnnotatedRandomKTrainTestSplit:
    def __init__(self, cfg: Config):
        ...
        train = pd.read_csv(path / 'split' / 'siim_group_kfold_drop.csv')
        ...
        if cfg.data.dedul:
            ...
            self.valid_meta = self.valid_meta[self.valid_meta.keep].copy()
        ...
        if cfg.basic.debug:
            ...
            self.valid_meta = self.valid_meta.sample(frac=0.03)
