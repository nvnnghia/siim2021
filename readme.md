...
--- | --- | --- | --- |--- |--- |--- |--- |---
swin_base_patch4_ window12_384 | oof | 0 | 0.565 | 0.811 | 1 | 384| bimcv+ricord | -
...
eca_nfnet_l1 | oof | 3 | 0.620 | 0.845 | 2_1 | 384 | all | n_cf15_1 (5cls)
...
eca_nfnet_l1 | oof | 2 | 0.599 | 0.833 | 1 | 384 | no | n_cf4
eca_nfnet_l1 | oof | 3 | 0.601 | 0.836 | 1 | 384 | no | n_cf4

* Multiple stage training with segmentation channel and NIH pretrained

Model | FOLD | stage | mAP | AUC | model type | input size |edata| config
--- | --- | --- | --- |--- |--- |--- |--- |---
eca_nfnet_l1 | oof | 0 | 0.565 | 0.809 | 2_1 | 384 | no | -

* Multiple stage training with segmentation channel and NIH pretraining and External data

Model | FOLD | stage | mAP | AUC | model type | input size |edata| config
--- | --- | --- | --- |--- |--- |--- |--- |---
eca_nfnet_l1 | oof | 0 | 0.582 | 0.822 | 2_1 | 384 | all | n_cf16 (5cls)
...
tf_efficientnet_b7 | oof | 1 | 0.590 | 0.827 | 5_1 | 512 | n_cf20
tf_efficientnet_b7 | oof | 2 | 0.601 | --- | 5_1 | 512 | n_cf20
...
eca_nfnet_l1 | oof | 1 | 0.593 | 0.831 | 6_1 | 512 | n_cf21
eca_nfnet_l1 | oof | 2 | 0.612 | 0.841 | 6_1 | 512 | n_cf21
eca_nfnet_l1 | oof | 3 | 0.614 | 0.844 | 6_1 | 512 | n_cf21
