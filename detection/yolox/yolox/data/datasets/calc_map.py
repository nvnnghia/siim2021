...
def map_calc(det_path, gt_path, output_filename, MINOVERLAP=0.5):
    """
...
def siim_map(gt_path, det_path):
    return map_calc(det_path=det_path, gt_path=gt_path, output_filename='map.txt')
