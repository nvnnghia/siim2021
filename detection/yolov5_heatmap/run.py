...
# os.system(f'CUDA_VISIBLE_DEVICES=1 python train.py --img-size 384 --epochs 50 --batch-size 8 --data ../yolov5/data/cf1_cls1_f0.yaml --cfg ../yolov5/models/yolov5x_1cls.yaml --weights ../../../../yolov5/pretrained/yolov5x.pt --project runs/384cf1_cls1_x_f0')
# os.system(f'CUDA_VISIBLE_DEVICES=1 python train.py --img-size 384 --epochs 50 --batch-size 8 --data ../yolov5/data/cf1_cls1_f1.yaml --cfg ../yolov5/models/yolov5x_1cls.yaml --weights ../../../../yolov5/pretrained/yolov5x.pt --project runs/384cf1_cls1_x_f1')
# os.system(f'CUDA_VISIBLE_DEVICES=1 python train.py --img-size 384 --epochs 50 --batch-size 8 --data ../yolov5/data/cf1_cls1_f2.yaml --cfg ../yolov5/models/yolov5x_1cls.yaml --weights ../../../../yolov5/pretrained/yolov5x.pt --project runs/384cf1_cls1_x_f2')
# os.system(f'CUDA_VISIBLE_DEVICES=1 python train.py --img-size 384 --epochs 50 --batch-size 8 --data ../yolov5/data/cf1_cls1_f3.yaml --cfg ../yolov5/models/yolov5x_1cls.yaml --weights ../../../../yolov5/pretrained/yolov5x.pt --project runs/384cf1_cls1_x_f3')
# os.system(f'CUDA_VISIBLE_DEVICES=1 python train.py --img-size 384 --epochs 50 --batch-size 8 --data ../yolov5/data/cf1_cls1_f4.yaml --cfg ../yolov5/models/yolov5x_1cls.yaml --weights ../../../../yolov5/pretrained/yolov5x.pt --project runs/384cf1_cls1_x_f4')
