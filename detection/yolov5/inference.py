...
if __name__ =="__main__":
    ...
    weights = [
            ...
            '../yolov5_heatmap/runs/384cf1_cls1_l_f0/exp/weights/best.pt',
            '../yolov5_heatmap/runs/384cf1_cls1_l_f1/exp/weights/best.pt',
            '../yolov5_heatmap/runs/384cf1_cls1_l_f2/exp/weights/best.pt',
            '../yolov5_heatmap/runs/384cf1_cls1_l_f3/exp/weights/best.pt',
            '../yolov5_heatmap/runs/384cf1_cls1_l_f4/exp/weights/best.pt',
    ...
    weights = [x for x in weights if '_f0' in x]
    print(len(weights))
    ...
    for batch_idx, batch_data in enumerate(bar):
        ...
        for is_hflip in [0,1]:
            ...
            for model, outname in zip(models, outnames):
                pred, _ = model(images, augment=False)
