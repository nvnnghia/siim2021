...
cfg = {
    ...
    "model_architecture": "dm_nfnet_f3",  # resnet200d, tf_efficientnetv2_m, eca_nfnet_l1, seresnext26tn_32x4d tf_efficientnet_b3_ns nf_regnet_b1 dm_nfnet_f1 densenet121 dm_nfnet_f4
    ...
    "out_dir": f"{outputdir}",
    "folds": [0, 1, 2, 3, 4],
    "augmentation": None, #"s_0220/0220_hf_cut_sm2_0.75_384_v1.yaml",
